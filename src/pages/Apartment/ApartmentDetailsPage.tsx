...
export default function ApartmentDetailsPage() {
  ...
  const setBasePrice = (data: Apartment) => {
  ...
  return (
    <>
      <div className="planel shadow-md flex-col flex justify-center bg-white rounded-md p-4 mb-5">
